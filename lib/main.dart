                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Text("Ready?",style: TextStyle(color:Colors.black,fontSize: 35),),
                          Container(
                            width: 250,
                           child: Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit.",textAlign: TextAlign.center , style: TextStyle(color:const Color.fromARGB(255, 20, 20, 20),fontSize: 15,),),
                          ),
                          Container(
                            height: 50,
                            width: 100,
        ...
        Row(
            ...
            children: List.generate(5, (index) {
              return Container(
                ...
                height: 12,
                decoration: BoxDecoration(
                  color: currentPage == index ? Colors.blue : Colors.blue[100],
